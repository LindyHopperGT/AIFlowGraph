...
#include "FlowBlackboardEntryValue_Vector.generated.h"

/**
 * Configuration object for setting blackboard entries for UBlackboardKeyType_Vector entries
 */
UCLASS(BlueprintType, DisplayName = "Vector Blackboard Value")
class AIFLOW_API UFlowBlackboardEntryValue_Vector : public UFlowBlackboardEntryValue
{
	GENERATED_BODY()
...
#if WITH_EDITOR
	virtual FString GetEditorValueString() const override  { return VectorValue.ToCompactString(); }
#endif // WITH_EDITOR
