...
#include "FlowBlackboardEntryValue_Name.generated.h"

/**
 * Configuration object for setting blackboard entries for UBlackboardKeyType_Name entries
 */
UCLASS(BlueprintType, DisplayName = "Name Blackboard Value")
class AIFLOW_API UFlowBlackboardEntryValue_Name : public UFlowBlackboardEntryValue
{
	GENERATED_BODY()
